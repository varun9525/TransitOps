...
async function seedDatabase(database: Database<sqlite3.Database, sqlite3.Statement>) {
  ...
  // Seed Users
  const users = [
    { id: "u1", name: "Maya Okonkwo", email: "maya@transitops.io", password: hashedPassword, role: "Fleet Manager" },
    { id: "u2", name: "Diego Ramirez", email: "diego@transitops.io", password: hashedPassword, role: "Driver" },
    { id: "u3", name: "Sara Novak", email: "sara@transitops.io", password: hashedPassword, role: "Safety Officer" },
    { id: "u4", name: "Liam Chen", email: "liam@transitops.io", password: hashedPassword, role: "Financial Analyst" },
  ];
  ...
  const maintenance = [
    { id: "m1", vehicleId: "v3", type: "Engine", description: "Coolant leak & belt replacement", cost: 1850, openedAt: "2026-07-05", closedAt: null, status: "Open" },
